            ...
            success: function (ress) {
              ...
              wx.getUserInfo({
                success: function (resx) {
                  ...
                  wx.request({
                    url: "https://hepulan.playonwechat.com/site/save-boost?sign=" + _sign + '&type=1',
                    method: "POST",
                    data: {
                    ...
                    success: function (ressucceed) {
                      ...
                      var hot_points = parseInt(that.data.hot_points) + 1;
                      var tadybootsts = parseInt(that.data.tadybootsts) + 1;
