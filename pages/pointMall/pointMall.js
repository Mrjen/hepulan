...
Page({
    ...
    opation_nav: [
      {
        ...
        text: "我的收藏",
        icon:
          "https://qncdn.playonwechat.com/hupulan/shopMall/point_mall_collect.png",
        id: 1
      },
      {
        ...
        text: "购物车",
        icon:
          "https://qncdn.playonwechat.com/hupulan/shopMall/point_mall_shopcar.png",
        id: 2
      },
      {
        ...
        text: "地址管理",
        icon:
          "https://qncdn.playonwechat.com/hupulan/shopMall/point_mall_adress.png",
        id: 3
      }
    ],
  ...
  onShow: function() {
    ...
    this.is_app_auth = wx.getStorageSync("is_app_auth");
    that.setData({
      avatarUrl: avatarUrl,
      nickName: nickName
    });
